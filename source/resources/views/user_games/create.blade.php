...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> User_games / Create </h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('user_games.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('user_id')) has-error @endif">
                    ...
                    <input type="text" id="game_rank-field" name="game_rank" class="form-control" value="{{ old("game_rank") }}"/>
