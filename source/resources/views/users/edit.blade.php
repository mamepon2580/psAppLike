        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="text" id="mail-field" name="mail" class="form-control" value="{{ is_null(old("mail")) ? $user->mail : old("mail") }}"/>
                       @if($errors->has("mail"))
                    ...
                    <input type="text" id="profile-field" name="profile" class="form-control" value="{{ is_null(old("profile")) ? $user->profile : old("profile") }}"/>
