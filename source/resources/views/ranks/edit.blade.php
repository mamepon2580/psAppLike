...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Ranks / Edit #{{$rank->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('ranks.update', $rank->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('game_id')) has-error @endif">
                    ...
                    <input type="text" id="game_id-field" name="game_id" class="form-control" value="{{ is_null(old("game_id")) ? $rank->game_id : old("game_id") }}"/>
                    ...
                    <input type="text" id="rank_int-field" name="rank_int" class="form-control" value="{{ is_null(old("rank_int")) ? $rank->rank_int : old("rank_int") }}"/>
                    ...
                    <input type="text" id="rank_str-field" name="rank_str" class="form-control" value="{{ is_null(old("rank_str")) ? $rank->rank_str : old("rank_str") }}"/>
