        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('friends.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('request_user_id')) has-error @endif">
                    ...
                    <input type="text" id="request_user_id-field" name="request_user_id" class="form-control" value="{{ old("request_user_id") }}"/>
                    ...
                    <input type="text" id="accept_user_id-field" name="accept_user_id" class="form-control" value="{{ old("accept_user_id") }}"/>
                    ...
                    <input type="text" id="flg_request-field" name="flg_request" class="form-control" value="{{ old("flg_request") }}"/>
                    ...
                    <input type="text" id="flg_block-field" name="flg_block" class="form-control" value="{{ old("flg_block") }}"/>
